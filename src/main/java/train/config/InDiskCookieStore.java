...
//
//    private final static Logger Log= LoggerFactory.getLogger(InDiskCookieStore.class);
//
...
//        } catch (IOException e) {
//            Log.debug(LOG_TAG, "IOException in encodeCookie", e);
//            return null;
//        }
//
...
//        } catch (IOException e) {
//            Log.debug(LOG_TAG, "IOException in decodeCookie", e);
//        } catch (ClassNotFoundException e) {
//            Log.debug(LOG_TAG, "ClassNotFoundException in decodeCookie", e);
//        }
//
//        return cookie;
//    }
